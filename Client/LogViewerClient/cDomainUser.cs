   ...
   public class cDomainGroup
    {
        ...
        {
            return  LogViewerClient.fMain.translateDN(m_GroupDN);
        }
    ...
    class cDomainUser
    {
        ...
        private void addDisableInfo(SqlConnection cs)
        {
            ...
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("INSERT INTO Users_ActivationHistory (ID_User,Status,Actts) VALUES (@idUser,@Status,GETDATE())", conn))
                {
